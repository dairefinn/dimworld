...
public partial class InventorySlotUI : Panel
{
    ...
    private static readonly StyleBox STYLEBOX_DEFAULT = GD.Load<StyleBox>("res://Core/Items/Inventory/UI/Slot/Styles/InventorySlotUI_Default.tres");
    private static readonly StyleBox STYLEBOX_ACTIVE = GD.Load<StyleBox>("res://Core/Items/Inventory/UI/Slot/Styles/InventorySlotUI_Active.tres");
    private static readonly StyleBox STYLEBOX_SELECTED = GD.Load<StyleBox>("res://Core/Items/Inventory/UI/Slot/Styles/InventorySlotUI_Selected.tres");
